    ...
    <SafeAreaView className='bg-primary h-full'>
         <ScrollView contentContainerStyle={{
           ...
           <View className="relative mt-5 items-center">
            ...
            <Image source={images.path} className="w-[136px] h-[15px] mt-1 absolute -bottom-4 -right-6" resizeMode="contain" />
          </View>

           <Text className="text-sm font-pregular text-gray-100 mt-7 text-center" >Where creativity meets Innovation:embrack on a journey of limitless exploration on Aora</Text>
